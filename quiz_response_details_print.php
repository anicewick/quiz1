...
$layout = new TLayout("print_bootstrap", "PurificGreen", "MobileGreen");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "quiz_response_details_print";
...
$page_layouts["quiz_response_details_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "quiz_response_details" );
