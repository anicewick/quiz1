...
$layout = new TLayout("export_bootstrap", "PurificGreen", "MobileGreen");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "quiz_response_details_export";
...
$page_layouts["quiz_response_details_export"] = $layout;
